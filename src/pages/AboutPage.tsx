...
const AboutPage = () => (
  <Layout>
    <div className="container py-12 md:py-16 max-w-3xl">
      <h1 className="font-serif text-4xl md:text-5xl font-bold mb-8">About CoreNews</h1>

      <div className="prose-article space-y-8">
        <section>
          <h2 className="font-serif text-2xl font-semibold mb-3">Our Mission</h2>
          <p className="text-foreground/80 leading-relaxed">
            CoreNews is an independent Nigerian news and media organization dedicated to providing accurate, balanced, and timely information. Our mission is to bring the most important stories to the public with clarity, integrity, and responsibility.
          </p>
        </section>
        ...
        <section className="border-t border-border pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            {[
              ...
              { title: "Innovation", desc: "We leverage AI and technology to enhance—never replace—journalism." },
            ].map((v) => (
