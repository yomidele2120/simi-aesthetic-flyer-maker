    ...
    return (
      ...
      >
        <Link to={`/article/${article.id}`}>
          ...
          <h3 className="text-lg font-serif font-semibold leading-tight headline-hover">
            {article.title}
          </h3>
    ...
    return (
      ...
      >
        <Link to={`/article/${article.id}`}>
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold leading-tight headline-hover">
            {article.title}
          </h1>
  ...
  return (
    ...
    >
      <Link to={`/article/${article.id}`}>
        ...
        {article.isOpinion && (
          <span className="text-xs font-bold uppercase tracking-widest text-accent mb-1 block">Opinion</span>
        )}
        <span className="category-tag mb-1 block">{article.category}</span>
        <h3 className="text-xl font-serif font-semibold leading-tight headline-hover">
          {article.title}
        </h3>
